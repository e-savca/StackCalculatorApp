namespace StackCalculatorApp.Calculator;
...
public class StackCalculator
{
    ...
    {
        if (parentheses.ContainsKey(currentOp) || operatorStack.Count == 0 || operatorStack.Peek() == "(")
            return true;
    ...
    private void PerformOperation()
    {
        ...
        switch (operatorSymbol)
        {
            ...
            case "/":
                ...
                break;
            default:
                throw new ArgumentException("Troubles with operatorSymbol: " + operatorSymbol);
        }
    }
}
